...
const nav = (active) => `<aside class="sidebar"><h2>景区场次预约 V3.4</h2><div class="group">版本迭代需求</div><a href="../index.html">← 返回版本列表</a><a class="${active === 'overview' ? 'current' : ''}" href="index.html">版本总览</a><a class="${active === 'prd' ? 'current' : ''}" href="development-spec.html">完整 PRD</a><a href="prototype-center.html">原型中心</a><div class="group">原型入口</div><a href="prototype/admin/index.html" ${external}>小程序管理端原型 ↗</a><a href="prototype/visitor/index.html" ${external}>游客端完整原型 ↗</a><a href="prototype/pc/index.html" ${external}>PC 后台原型 ↗</a><div class="group">PRD 目录</div>${toc}<div class="group">辅助文档</div><a href="docs/HTML原型页面清单V3.4.md" ${external}>HTML 原型页面清单 ↗</a><a href="docs/HTML原型页面样式清单V3.4.md" ${external}>页面样式清单 ↗</a><a href="docs/预约小程序Figma与主题规范V3.4.md" ${external}>小程序全局规范 ↗</a><a href="${prdName}" ${external}>原始 Markdown ↗</a></aside>`;
