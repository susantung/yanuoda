...
function prototypeLink(heading) {
  const routes = [
    ...
    ['8. 批量导入充值', '#/recharge?tab=account'],
    ['9. 资金流水', '#/flow?tab=all'],
    ['10. 订单与退款处理', '#/order-detail?orderNo=DD202608050011'],
    ['10.4 报表中心：合作伙伴对帐单', 'partner-statement'],
    ['11.7 售票窗口合作伙伴工作区', 'partner-workspace'],
    ['11. 售票窗口', null],
    ['7.8 临时客户转合作伙伴', '#/recharge?tab=account']
  ];
...
function render(markdown) {
  ...
  closeList();
  return html.replace(/<h3 id="3-4-总体业务流程图">[\s\S]*?(?=<h2 id="4-核心对象与数据口径">)/, flowBlock3);
}
...
const overview = `${head('V3.2 散客合作伙伴管理-20260805｜方案总览')}<body>${nav('overview')}<main class="main"><header class="hero"><div class="eyebrow">开发 / 测试共同方案</div><h1>V3.2 散客合作伙伴管理-20260805</h1><p>以可正可负的双账户为基础，重新统一合作伙伴账户、充值、公共临时客户回款与资金流水口径。</p><div class="actions"><a class="btn" href="development-spec.html">查看完整需求方案</a><a class="btn" href="prototype-center.html">打开原型中心</a><a class="btn" href="${prototypeBase}" ${external}>打开后台原型 ↗</a><a class="btn" href="${ticketPrototypeBase}" ${external}>打开售票窗口 ↗</a><a class="btn" href="${partnerWorkspaceBase}" ${external}>打开合作伙伴页 ↗</a><a class="btn" href="PRD｜散客合作伙伴管理_V3.2_20260805.md" ${external}>打开完整 Markdown ↗</a></div></header><section class="section"><h2>本次已确认改造</h2><div class="card"><p class="lead">企业与个人同时保留挂帐、预付款两个账户；账户类型决定财务归属，金额正负只表示账户增加或扣减。公共临时客户继续采用按订单回款的特殊逻辑。</p><div class="grid"><div class="metric"><strong>2</strong>企业/个人子账户</div><div class="metric"><strong>4</strong>充值类型</div><div class="metric"><strong>1</strong>公共临时客户共享账户</div></div></div></section><section class="section"><h2>本版处理范围</h2><div class="card"><table><thead><tr><th>模块</th><th>已确认处理</th></tr></thead><tbody><tr><td>合作伙伴档案</td><td>账户支付方式、负责人、状态与切换校验。</td></tr><tr><td>账户管理</td><td>挂帐和预付款均可正负；分别配置额度限制。</td></tr><tr><td>充值与导入</td><td>支付时间、客户/付款人、支付方式、调账、其他收入和按行导入结果。</td></tr><tr><td>公共临时客户</td><td>挂帐回款、已回款退款调账，以及未回款订单转长期合作伙伴。</td></tr><tr><td>资金流水</td><td>全部/充值/消费/退款/其他收入/调账，按单据类型跳转与复制。</td></tr></tbody></table></div></section><section class="section"><h2>当前原型覆盖</h2><div class="card"><p>后台原型已包含临时客户转合作伙伴的选择与目标资料联动，以及公共临时客户、企业、个人三类订单详情样例；售票窗口与“合作伙伴”管理页为独立原型入口，可从原型中心打开。</p></div></section></main>${topButton}</body></html>`;
