...
const bookings = [
  ...
  { id:4, activityId:1, status:'cancelled', number:'018', name:'周宁', phone:'13500135000', date:'2026-08-19', session:'12:30-13:30', sessionName:'溪降下午体验场', category:'常规溪降', project:'常规溪降 A 线', people:1, created:'08-18 16:40', cancelTime:'2026-08-19 08:10', cancelType:'visitor', cancelReason:'临时行程变化，无法按时参与。', singleChoice:'无需教练陪同', multiChoice:'成人防滑鞋', customNumber:'1', customDate:'2026-08-19', singleText:'自行到场', multiText:'临时行程变化。' },
