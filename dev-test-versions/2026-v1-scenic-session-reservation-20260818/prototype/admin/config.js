(() => {
  ...
  function projectLogoEditorHtml(name,image){
    const source=typeof image==='string'?image:'../../scenic-reservation/preview/assets/activity-hero.jpg';
  ...
  function openPreview() {
    ...
    frame.src=`../../scenic-reservation/preview/index.html?configPreview=${Date.now()}`;
  }
